...
$(document).ready(() => {
    ...
    $('form').submit((event) => {
        ...
        if(form.checkValidity() === true) {
            ...
            let firstConference = document.querySelector('input[name="firstConference"]:checked').value;
            var currency = 'NGN';
            ...
            fetch('scripts/paynow.php', {
                ...
                .then((data) => {
                    if(data === 'user_exists') {
                        swal("Already Registered", "You have already registered for the conference.", "error");
                        setTimeout(function () {
